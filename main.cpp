...
// MOUSE FUNCTIONS AND RECTANGLE
    while(true){
        ...
        // column 2 Pants
            ...
            if(!pantsClicked){
                printImage (620, 600, 19); //yellow pants
        ...
        // column 3 Shoes
            ...
            if(!shoesClicked){
                printImage (620, 860, 21);
                printImage (750, 860, 21);
        ...
        // column 4 Accessories
            ...
            if(!accClicked){
                printImage (660, 340, 13); // pink glasses
            ...
            if(!accClicked){
                printImage (645, 425, 15); // flower necklace
